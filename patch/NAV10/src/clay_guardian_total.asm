...
; game.  This file uses the character's total defense (including armor) as
; the source value.
; 
...
.org 0x80110A64
.area 0x80110A80-.
	lhu	$a0, 0x32($v1)		; total defense
	lhu	$1, 0x32($v1)		; total defense (may as well keep the pattern rather than optimize)
